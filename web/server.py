...
A = {
    ...
    "remote-hestia-users": (["remote", "hestia", "users"], [], False),
    ...
    "adoptar-historial": (["adoptar", "--historial"],
                          [("usuarios", "--usuarios", _v_usuarios)], False),
    "adoptar-como-dry": (["adoptar", "--dry-run"],
                         [("destino", "--to", _v_destino),
                          ("usuarios", "--usuarios", _v_usuarios),
                          ("como", "--como", _v_usuarios),
                          ("snapshot", "--snapshot", _v_snapshot)], False),
    "adoptar-como": (["adoptar"],
                     [("destino", "--to", _v_destino),
                      ("usuarios", "--usuarios", _v_usuarios),
                      ("como", "--como", _v_usuarios),
                      ("snapshot", "--snapshot", _v_snapshot)], True),
    "adoptar-bases-dry": (["adoptar-bases", "--solo-desconocidas", "--dry-run"],
                          [("destino", "--to", _v_destino),
                           ("zip", "--zip", _v_zip),
                           ("prefijo", "--prefijo", lambda v: bool(re.match(r"^[A-Za-z0-9_]{1,20}$", v)))], False),
    "adoptar-bases": (["adoptar-bases", "--solo-desconocidas"],
                      [("destino", "--to", _v_destino),
                       ("zip", "--zip", _v_zip),
                       ("prefijo", "--prefijo", lambda v: bool(re.match(r"^[A-Za-z0-9_]{1,20}$", v)))], True),
    "adoptar-registrar-dry": (["adoptar-registrar", "--dry-run"],
                              [("destino", "--to", _v_destino),
                               ("usuario_hestia", "--usuario-hestia", _v_usuarios)], False),
    "adoptar-registrar": (["adoptar-registrar"],
                          [("destino", "--to", _v_destino),
                           ("usuario_hestia", "--usuario-hestia", _v_usuarios)], True),
